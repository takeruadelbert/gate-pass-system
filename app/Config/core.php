 ...
 *
 */
Configure::write('Routing.prefixes', array('admin', 'front', 'member', 'api'));
...
Configure::write('Session', array(
    ...
    'autoRegenerate' => true,
    'checkAgent' => false,
    'save' => 'gate_pass_system',
    'cookie' => 'gate_pass_system',
    'ini' => array(
 ...
 */
Configure::write('Security.salt', 'EosjiqS02d9i3doQod93d9q9dk93jd9e9djmD');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '928303948203804830283402938');
