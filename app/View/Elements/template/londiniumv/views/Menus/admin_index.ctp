<?php
echo $this->element(_TEMPLATE_DIR . "/{$template}/filter/menu");
?>
                        ...
                        if (empty($data['rows'])) {
                            ...
                            foreach ($data['rows'] as $item) {
                                ...
                                <tr id="row-<?= $i ?>" class="removeRow<?php echo $item[Inflector::classify($this->params['controller'])]['id']; ?>">
                                    ...
                                    <td class="text-center"><?= $item['Menu']['label'] ?></td>
                                    <td class="text-center"><?= $item['Menu']['position'] ?></td>
                                    <td class="text-center"><?= $this->Echo->empty_strip(@$item['Module']['name']) ?></td>
                                    <td class="text-center"><i class="<?= $item['Menu']['class_icon'] ?>"></i> <?= $item['Menu']['class_icon'] ?></td>
                                    <td class="text-center"><?= $item['Menu']['ordering_number'] ?></td>
