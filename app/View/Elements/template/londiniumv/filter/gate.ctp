        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label><?= __("Tipe Gate") ?></label>
                        <?= $this->Form->input(null ,["default" => isset($this->request->query['select_Gate_gate_type_id']) ? $this->request->query['select_Gate_gate_type_id'] : '', "name" => "select.Gate.gate_type_id", "div" => false, 'label' => false, 'class' => 'select-full', 'empty' => '', 'placeholder' => '- Semua -', 'options' => $gateTypes]) ?>
                    </div>
                </div>
            </div>
            <div>
