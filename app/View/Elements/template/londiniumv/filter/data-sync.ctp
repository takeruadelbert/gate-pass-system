    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <label><?= __("Request Method") ?></label>
                        <?= $this->Form->input(null, array("default" => isset($this->request->query['DataSync_request_method']) ? $this->request->query['DataSync_request_method'] : '', "name" => "DataSync.request_method", "div" => false, "label" => false, "class" => "form-control tip", "placeholder" => "HTTP Request Method")) ?>
                    </div>
                    <div class="col-md-3">
