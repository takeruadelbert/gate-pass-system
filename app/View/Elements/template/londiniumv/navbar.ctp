<div class="navbar navbar-inverse" role="navigation">
    ...
    ?>
    <div class="navbar-header"><a class="navbar-brand" href="<?= Router::url("/admin/dashboard", true) ?>"><img style="height:50px" src="<?= Router::url($logo, true) ?>" alt="Gate Pass System" title="<?= _APP_CORPORATE?>"></a></div>
